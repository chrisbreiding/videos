(function() {
  ...
  define(['backbone', 'handlebars', 'services/vent', 'text!template/playlist.html'], function(Backbone, Handlebars, vent, template) {
    var PlaylistView;
    return PlaylistView = (function(_super) {
      ...
      PlaylistView.prototype.template = Handlebars.compile(template);
