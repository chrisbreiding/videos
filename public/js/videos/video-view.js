(function() {
  ...
  define(['backbone', 'handlebars', 'templates/video.hb', 'videos/current-video-view', 'template-helpers/date', 'template-helpers/duration'], function(Backbone, Handlebars, template, CurrentVideoView) {
    var VideoView;
