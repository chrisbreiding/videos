(function() {
  ...
  define(['backbone', 'handlebars', 'services/vent', 'services/youtube', 'templates/subscription.hb', 'playlists/playlists-view'], function(Backbone, Handlebars, vent, youtube, template, PlaylistsView) {
